...
namespace AttendanceManagement
{
    ...
    public partial class HistoryForm : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            searchAttendances(employee_id, dtpWorkStart.Value, dtpWorkEnd.Value);
        }
        ...
        /// 勤怠履歴を表示
        /// </summary>
        private void searchAttendances(string employee_id, DateTime start, DateTime end)
        {
            if (configuration == null)
            {
                return;
